"""
Alex Fick, November 2024, Dartmouth College
...
def main():
    ...
    if prompt == True:
        while prompt:
            ...
            csvAttributeString = raw_input("\n\nIn what order would you like the colums of the CSV file?\n" +
                                           ...
                                           " ArtistName, ArtistMbTags, EndOfFadeIn, Energy, StartOfFadeOut, Mode, ModeConfidence, Danceability, Duration, KeySignature, KeySignatureConfidence, Tempo," +
            ...
            csvAttributeList = re.split(r'\W+', csvAttributeString)
            ...
            for attribute in csvAttributeList:
                ...
                if attribute == 'AlbumID'.lower():
                    ...
                    "=============="
                    print
                    "I believe there has been an error with the input."
                    print
                    "=============="
                    break
    ...
    # the user,
        ...
        csvRowString = ("SongID,AlbumID,AlbumName,ArtistID,ArtistLatitude,ArtistLocation," +
                        "ArtistLongitude,ArtistName,ArtistMbTags,EndOfFadeIn,Energy,StartOfFadeOut,Mode,ModeConfidence,Danceability,Duration,KeySignature," +
                        "KeySignatureConfidence,Tempo,TimeSignature,TimeSignatureConfidence," +
                        "Title,Year")
        #################################################

        csvAttributeList = re.split(r'\W+', csvRowString)
        for i, v in enumerate(csvAttributeList):
            csvAttributeList[i] = csvAttributeList[i].lower()
    ...
    for root, dirs, files in os.walk(basedir):
        ...
        for f in files:
            ...
            for attribute in csvAttributeList:
                ...
                # ArtistMbTags, EndOfFadeIn, Energy, StartOfFadeOut, Mode, ModeConfidence
                elif attribute == 'ArtistMbTags'.lower():
